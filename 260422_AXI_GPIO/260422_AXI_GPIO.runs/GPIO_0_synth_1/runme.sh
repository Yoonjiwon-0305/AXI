...
HD_PWD='D:/workplace/AXI/260422_AXI_GPIO/260422_AXI_GPIO.runs/GPIO_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO_0.tcl
