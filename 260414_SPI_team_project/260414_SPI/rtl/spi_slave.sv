...
module spi_slave (
    ...
    assign sclk_rising_edge  = (sclk_sync[1:0] == 2'b01);
    assign sclk_falling_edge = (sclk_sync[1:0] == 2'b10);
    assign cs_n_falling_edge = (cs_n_sync[1:0] == 2'b10);
    assign cs_n_rising_edge  = (cs_n_sync[1:0] == 2'b01);
