...
set_property -dict { PACKAGE_PIN V2    IOSTANDARD LVCMOS33 } [get_ports {btn[4]}]
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports {btn[5]}]
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports {btn[6]}]
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports {btn[7]}]
...
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[4]}]
set_property -dict { PACKAGE_PIN V3    IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[5]}]
set_property -dict { PACKAGE_PIN W3    IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[6]}]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[7]}]
# set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[8]}]
# set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[9]}]
# set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[10]}]
# set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {fnd_digit[11]}]
...
set_property -dict { PACKAGE_PIN G2   IOSTANDARD LVCMOS33 } [get_ports cs_n];#Sch name = JA4
...
#set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports cs_n];#Sch name = XA4_P
